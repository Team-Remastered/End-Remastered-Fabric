...
public class ERBlocks {
    ...
    public static final Block END_CRYSTAL_BLOCK =  new GlassBlock(FabricBlockSettings.of(Material.GLASS).requiresTool().strength(5.0F, 6.0f).sounds(BlockSoundGroup.AMETHYST_BLOCK).nonOpaque());
